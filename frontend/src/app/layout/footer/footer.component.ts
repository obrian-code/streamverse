          ...
          <div class="space-y-4">
            ...
            <div class="flex items-center gap-3">
              <a href="https://facebook.com/streamverse" target="_blank" rel="noopener noreferrer" aria-label="Facebook"
                 class="w-9 h-9 rounded-full bg-surface-800 flex items-center justify-center hover:bg-surface-700 hover:text-blue-500 transition-colors text-surface-400">
              ...
              <a href="https://twitter.com/streamverse" target="_blank" rel="noopener noreferrer" aria-label="Twitter"
                 class="w-9 h-9 rounded-full bg-surface-800 flex items-center justify-center hover:bg-surface-700 hover:text-sky-400 transition-colors text-surface-400">
                <svg viewBox="0 0 24 24" class="w-5 h-5" fill="currentColor">
              ...
              <a href="https://instagram.com/streamverse" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                 class="w-9 h-9 rounded-full bg-surface-800 flex items-center justify-center hover:bg-surface-700 hover:text-pink-500 transition-colors text-surface-400">
                <svg viewBox="0 0 24 24" class="w-5 h-5" fill="currentColor">
              ...
              <a href="https://youtube.com/@streamverse" target="_blank" rel="noopener noreferrer" aria-label="YouTube"
                 class="w-9 h-9 rounded-full bg-surface-800 flex items-center justify-center hover:bg-surface-700 hover:text-red-600 transition-colors text-surface-400">
                <svg viewBox="0 0 24 24" class="w-5 h-5" fill="currentColor">
